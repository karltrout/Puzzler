...
public class Homework5 {
  ...
  public ArrayList<SlidingTilePuzzle> solver(SlidingTilePuzzle start) {
    ...
    //Step1: pass in puzzle -- for testing purposes
    //Step2: add "path" -- the sliding tile puzzle -- to arrayList
    //Step3: Check if done
    //...
    //Recursion -- do something within the puzzle and call the method with the new puzzle
